							...
							<div class="col-lg-6 footer_col">
								...
								<div class="footer_section footer_about">	
									...
									<div class="footer_about_text">
										<p>Sistem Informasi Guru dan Siswa SMA Baskoro Raya</p>
									</div>
				...
				<div class="col">
					<div class="copyright d-flex flex-lg-row flex-column align-items-center justify-content-start">
						<div class="cr_text"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by Baskoro Admin IT Team | Thanks to <a href="https://colorlib.com" target="_blank">Colorlib</a>
